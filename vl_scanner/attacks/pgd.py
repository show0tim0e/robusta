...
class PGD(Attack):
    ...
    @staticmethod
    def description() -> str:
        return ("Projected Gradient Descent (PGD) is an iterative adversarial attack that generates adversarial examples "
                "by repeatedly applying small perturbations to the input in the direction of the gradient of the loss with "
